...
from bitcoin_cash_test_framework.blocktools import (create_block, create_coinbase)
from bitcoin_cash_test_framework.mininode import (
    CInv,
    NetworkThread,
    NodeConn,
    NodeConnCB,
...
from bitcoin_cash_test_framework.util import (
    assert_equal,
    connect_nodes,
    p2p_port,
    wait_until,
...
def custom_function():
    ...
    moving it to a module in bitcoin_cash_test_framework."""
